...
class DocumentComparatorLLM:
    def __init__(self) -> None:
        ...
        self.log.info("DocumentComparatorLLM is initialized with model and parameter.")
    ...
    def compare_documents(self,combined_docs: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise DocumentPortalException("An error occurred while comparing documents.",e)
    ...
    def _format_response(self,response_parsed: list[dict]) -> pd.DataFrame: #type: ignore
        ...
        try:
            ...
            raise DocumentPortalException("Error formatting response",context={"error":str(e)})